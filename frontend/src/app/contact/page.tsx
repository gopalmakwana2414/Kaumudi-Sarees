        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-14">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full border p-3 rounded-xl outline-none focus:border-[#d4af37] transition resize-none"
                  />
                </div>
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-bold">Our Details</h2>
              ...
              {[
                ...
                <div
                  key={item.label}
                  className="flex items-start gap-4 bg-white border rounded-2xl p-5 hover:shadow-sm transition"
                >
