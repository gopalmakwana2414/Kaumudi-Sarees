...
const FEATURES = [
  {
    icon: <Factory size={28} className="text-primary" />,
  ...
  {
    icon: <RefreshCcw size={28} className="text-primary" />,
...
export default function WhyUs() {
  return (
    <section className="py-20 bg-[#1a0004] text-white">
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {FEATURES.map((feature) => (
            <div
              key={feature.title}
              className="bg-white/5 border border-white/10 rounded-2xl p-7 hover:border-primary/50 hover:bg-white/10 transition-all duration-300 group"
            >
